      ...
      <section className="max-w-[1170px] mx-auto px-6 py-[30px] flex justify-center items-center min-h-[370px]">
        <div className="flex flex-col md:flex-row items-center justify-between p-10 gap-[80px] w-full">
          <div className="text-center md:text-left">
            <p className="md:text-[20px] text-[15px] font-medium text-zinc-300">
              Jr.
            </p>
            <h2 className=" text-4xl md:text-6xl font-bold bg-gradient-to-r from-red-200 via-blue-300 to-yellow-200 bg-400 bg-clip-text text-transparent animate-gradient-move  ">
              Frontend Developer
            </h2>
            <p className="md:text-[20px] text-[15px] text-zinc-300 my-6">
              Hi 👋🏻 I'm Aysenur. I’m a Frontend Developer with a passion for
